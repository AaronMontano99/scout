...
10. Use research to sound prepared, not to sound like you've been watching them. Prefer natural personalization ("As the CFO, I figured you'd have visibility into...") over research-flaunting personalization ("I noticed from my research that..." / "I saw your LinkedIn post..."). If there's a strong company-specific fact, use it naturally — don't force research into the message just to prove it happened.
...
SUBJECT LINES (when writing an email): short and plain, e.g. "Quick intro", "[Name], following up", "[Company] + [Rep Company]". Never clickbait ("Unlocking Growth Opportunities", "Transform Your Technology Strategy").

MEETING ASKS: direct. "I'd like to get 20 minutes with you and compare notes. Does [time] or [time] work better?" Never "Would you be opposed to..." or "If it makes sense, perhaps we could potentially...".
